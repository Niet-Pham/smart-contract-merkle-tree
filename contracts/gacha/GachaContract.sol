    ...
    ReentrancyGuardUpgradeable
{
    ...
    function updateMerkleRoot(uint256 eventId, bytes32 merkleRoot) external  whenNotPaused onlyOperator gachaEventExist(eventId) {
    ...
    function buyBox(
        ...
        require(gachaEvent.totalBoxesPurchased < gachaEvent.totalBoxes, "Out of stock");        

        uint256 boxId = boxContract.mint(
            _msgSender(),
            boxData
        );
